        ...
        <div className="glass glass-elevated rounded-lg p-6 sm:p-8 relative z-10 hover-lift">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-text-secondary">
              {isEarlyBird 
                ? t('email.early_bird_message') 
                : t('email.regular_message')}
            </p>
            ...
            <div className="mt-6 space-y-2">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <button
                  onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent(`${t('email.share_text')} ${window.location.href}`)}`, '_blank')}
                  className="p-2 glass rounded-lg hover:bg-surface-raised transition-colors duration-200"
