...
type Props = React.SVGProps<SVGSVGElement> & { title?: string, gradient?: boolean };
export default function LogoQ({ title = "Coquinate", gradient = true, ...props }: Props) {
  const teal = "#2AA6A0"; const coral = "#E96E68"; const ink = "#0F1B1A";
  return (
