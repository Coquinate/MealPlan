 ...
 */
export const ROMANIAN_DATE_OPTIONS: Intl.DateTimeFormatOptions = {
  year: 'numeric',
  month: '2-digit', 
  day: '2-digit'
}
 ...
 */
export const ROMANIAN_TIME_OPTIONS: Intl.DateTimeFormatOptions = {
  hour: '2-digit',
  minute: '2-digit',
  hour12: false
}
 ...
 */
export const ROMANIAN_DATETIME_OPTIONS: Intl.DateTimeFormatOptions = {
...
export function formatDate(date: Date | string | number): string {
  try {
    ...
    return new Intl.DateTimeFormat(ROMANIAN_LOCALE, ROMANIAN_DATE_OPTIONS)
      .format(dateObj)
  } catch (error) {
    return 'Invalid Date'
  }
...
export function formatTime(date: Date | string | number): string {
  return new Intl.DateTimeFormat(ROMANIAN_LOCALE, ROMANIAN_TIME_OPTIONS)
...
export function formatDateTime(date: Date | string | number): string {
  return new Intl.DateTimeFormat(ROMANIAN_LOCALE, ROMANIAN_DATETIME_OPTIONS)
    .format(new Date(date))
}
 ...
 * ```
 */
export function formatServings(servings: number, unit: string = 'porții'): string {
  if (servings === 1) {
...
export function formatIngredientAmount(
  ...
  const romanianUnit = (COOKING_UNITS as any)[unit] || unit
 ...
 */
function getPluralCookingUnit(unit: string, amount: number): string {
