// Next.js types - conditionally imported when Next.js is available
type NextApiRequest = {
  url?: string
  headers: {
    cookie?: string
 ...
 */
export function detectLanguageSSR(
 ...
 */
export async function initializeI18nSSR(
  language: string = 'ro',
...
export async function getI18nServerSideProps(
  ...
  try {
    ...
    const initialI18nStore: Record<string, Record<string, any>> = {}
