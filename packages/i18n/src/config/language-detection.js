...
export const changeLanguage = (language) => languageManager.changeLanguage(language);
export const getCurrentLanguage = () => languageManager.getCurrentLanguage();
export const isLanguageSupported = (language) => languageManager.isLanguageSupported(language);
...
export function useLanguageManager() {
  ...
  const handleLanguageChange = React.useCallback(async (language) => {
    try {
