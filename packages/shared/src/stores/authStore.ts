...
export const useAuthActions = () => {
  ...
  return React.useMemo(
    () => ({
      ...
      reset: store.reset,
      resetRefreshAttempts: store.resetRefreshAttempts,
      incrementRefreshAttempts: store.incrementRefreshAttempts,
      scheduleSessionRefresh: store.scheduleSessionRefresh,
      clearSessionRefresh: store.clearSessionRefresh,
    }),
    [
      store.setUser,
      store.setProfile,
      ...
      store.incrementRefreshAttempts,
      store.scheduleSessionRefresh,
      store.clearSessionRefresh,
    ]
  );
};
